...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        <!-- Navigation -->
        <div id="app" class="appTwo">
            @yield('content')
        </div>
        <!--Footer-->
        <footer id="rfooter" class="rfooter">
        ...
        <script src="{{ asset('formHelper/js/bootstrap-formhelpers-languages.js') }}"></script>
        <script src="{{ asset('formHelper/js/bootstrap-formhelpers-datepicker.js') }}"></script>
        <script src="{{ asset('formHelper/js/bootstrap-formhelpers-phone.js') }}"></script>
        <script src="{{ asset('formHelper/js/bootstrap-formhelpers-selectbox.js') }}"></script>
